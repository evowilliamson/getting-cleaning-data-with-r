...
write.table(raw_dataframe, "./getting_cleaning_data_dataset.csv", quote=FALSE, row.names=FALSE)
...
## Write dataset to file
write.table(averages, "./getting_cleaning_data_averages.csv", quote=FALSE, row.names=FALSE)
